...
- 👨‍💻 I am a **software developer** (fullstack/web2) (~~system/DS/ML/AI/gamedev/VR/AR/IoT/blockchain/web3/dApps/hacking,engineer/researcher/scientist/businessman~~).
...
- ⚙️ **Backend**
  ...
  - <ins>API</ins> (*REST*): ⚡️⚡️⚡️⚡️⚡️⚡️⚡️⚡️
...
- 🖼 **Frontend**
  ...
  - 🕸 Web
    ...
    - <ins>Apps</ins> (*SPA/SSR*): ⚡️⚡️⚡️⚡️⚡️⚡️
...
![Yandex Cloud](https://img.shields.io/badge/cloud-5282ff?logo=data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAS0lEQVQ4jb2RMRIAIAjD+P+ndXOxQKqenZtw1giRkUR1EYhEFJYSF94kVwJ0oThkLY4Fzi/9E+iHQkEGr25VaOEnghMJXhnDaHGRCfIwxVcyn6/VAAAAAElFTkSuQmCC&style=flat&logoColor=white)
...
[Layout](https://github.com/stars/nezort11/lists/design-stack):
...
<details>
  ...
  - Frontend webapp development (w/ or w/o design)

  - Cloud production deployment

  Features I include in this gig:

  - Authentication (session/token/JWT/social/oauth)

  - Authorization (administration, permissions, throttling)

  - OpenAPI schema/documentation (Swagger/Redoc/...)

  - API querying features (pagination, filtering, searching, ordering, aggeratign, grouping)
