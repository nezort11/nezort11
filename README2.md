...
No social media stuff, only work/job/hobby related platforms.

GitHub
GitLab
GitFlic (russian local GitHub for Russia-related projects)
CodeBerg
...
I don't use Flutter, TypeScript, Redux, Material Design, Electron, because they are for too meat or heavy projects.
...
![Django REST Framework](https://img.shields.io/badge/drf-a30000?logo=data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAAZElEQVRYhe3TwQkAMAhDUfdfuj312GLEqIVkgf9ANPtx67K2cAnEG6chWgFoPB0hgAARRGp8BABBUOJeBDX+gpSFtbMxtx/1AVSEN05DtALQeDpCAAEiiNT4CACCoMQ9EHqYsQ0Nh9tdd7/PJgAAAABJRU5ErkJggg==&style=flat&logoColor=white)
...
[Frontend](https://github.com/stars/nezort11/lists/frontend-stack) (web, webview, mobile, vk, telegram):
...
![Python](https://img.shields.io/badge/python-3670A0?style=flat&logo=python&logoColor=white)
Telegram telegram (automation, bots, notifications, ... => instead of SMS)
requests?
...
Decisions I made when choosing the stack (factors):

Python:

- Rapid programming
- Pythonic
- Great outside web development (data science)
- Popularity
...
If you want you can look at my job [resume](Backend Developer CV 3.1.pdf).

## 📅 Other projects

- [Filehole](https://github.com/nezort11/filehole) (personal): LAN file sharing made fast
...
- [deliveryHunt](https://github.com/nezort11/deliveryHunt): Express delivery service
- [Demanage](https://github.com/nezort11/demanage): Boarding-style project management webapp
- [RankRise](https://github.com/nezort11/rankrise): Q/A product ranking API
- [Chaticket](https://github.com/nezort11/chaticket): Real-time web application for chatting
- [Anyberry](https://github.com/nezort11/anyberry): E-commerce website for buying virtual berries
- [Converic](https://github.com/nezort11/converic): Online image format converter
- [Auction](https://github.com/nezort11/auction-commerce): Auction e-commerce platform for selling goods
- [Social network](https://github.com/nezort11/network): Social networking website for making posts
- [Mail](https://github.com/nezort11/django-mail): Send mail over HTTP to the other users
...
![GitHub summary](https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=nezort11&theme=solarized) 
...
![GitHub commits per hour](https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=nezort11&theme=solarized)
...
[I don't use social media so much but if you want to learn more about me, see me, life, ...
look at this sites]

Mastadon (Twitter)
https://mastodon.social/@nezort11

Pixelfed (Instagram)
https://pixelfed.social/nezort11
